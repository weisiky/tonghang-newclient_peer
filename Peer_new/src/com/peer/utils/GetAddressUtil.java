...
public class GetAddressUtil {
	...
	/**
	 * Region data read from the assets, save as type list
	 */
	...
	/**
	 * Corresponding to the cities and provinces
	 * 
	 * @return 省份
	 */
	...
	/**
	 * Corresponding to the list of cities for provinces
	 * 
	 * @param province
	 *           
	...
	/**
	 * Through the city access province
	 */
