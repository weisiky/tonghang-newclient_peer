...
public class HomeFragment extends pBaseFragment {
	 ...
	 * 
	 * @Override protected List doInBackground(Void... arg0) { // TODO
	 * Auto-generated method stub return null; } }
	 */

	/*
	 * private void RefreshListner() { // TODO Auto-generated method stub
	 * pageViewaList.pull_refresh_homepage.setOnRefreshListener(new
	 * OnRefreshListener2<ListView>() {
	 * 
	 * @Override public void onPullDownToRefresh( PullToRefreshBase<ListView>
	 * refreshView) { // TODO Auto-generated method stub String label =
	 * DateUtils.formatDateTime(getActivity().getApplicationContext(),
	 * System.currentTimeMillis(), DateUtils.FORMAT_SHOW_TIME |
	 * DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);
	 * refreshView.getLoadingLayoutProxy().setLastUpdatedLabel(label);
	 * RefreshTask task=new RefreshTask(); task.execute("DownToRefresh"); }
	 * 
	 ...
	 * DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);
	 * refreshView.getLoadingLayoutProxy().setLastUpdatedLabel(label);
	 * RefreshTask task=new RefreshTask(); task.execute("UpToRefresh"); } }); }
	 */
