...
import com.peer.bean.ComeMsgBean;
...
//	private ArrayList<ComeMsgBean> comeMsgList;
...
//		comeMsgBean.setEmCoversationlist(loadConversationsWithRecentChat());
//		list=comeMsgBean.getEmCoversationlist();
