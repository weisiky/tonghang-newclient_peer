...
public class ChatRoomListnikeActivity extends pBaseActivity {
	...
	protected void processBiz() {
		...
		try {
			sendUserNumber(intent.getStringExtra("groupId"), page,
	...
	// // TODO Auto-generated method stub
	// return getLayoutInflater().inflate(R.layout.activity_chatroom_listnike,
	// null);
	// }
	//
	// @Override
...
//		sendSystemConfig();
	...
	private void sendUserNumber(String groupid, final int page, String client_id)
		...
		try {
			params = PeerParamsUtils.getUserNumberParams(
					ChatRoomListnikeActivity.this, groupid, page, client_id);
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}

		HttpUtil.post(HttpConfig.NUMBER_IN_URL, params,
								...
								if (recommenduserbean != null) {
									...
									if (adapter == null) {
										adapter = new FriendsAdapter(
												ChatRoomListnikeActivity.this,
												userlist, recommenduserbean
														.getPic_server());
										pageViewaList.lv_listnike_chatroom
												.setAdapter(adapter);
									}
								}
