...
public class SingleChatRoomActivity extends pBaseActivity {
	...
	class PageViewList {
		...
		private RelativeLayout rl_bottom,rl_sendphoto;
		private ImageView host_image, im_downview,sendphoto_unfold,sendphoto_close;
		private ListView lv_chat;
		private Button btn_send;
		private EditText et_sendmessage;
		private LinearLayout ll_back,ll_bottom,ll_selectpic,ll_pic,ll_photo;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pageViewaList.ll_photo.setDrawingCacheEnabled(true);
	}
	...
	protected void onResume() {
		...
		Intent eintent = new Intent(getExplicitIntent(
				SingleChatRoomActivity.this, mIntent));
		stopService(eintent);
		
		mShareFileUtils.setBoolean(Constant.SERVICEISRUN, false);
	...
	protected void onPause() {
		...
		mShareFileUtils.setBoolean(Constant.SERVICEISRUN, true);
	...
	protected void setListener() {
		...
		pageViewaList.rl_sendphoto.setOnClickListener(this);
		pageViewaList.ll_pic.setOnClickListener(this);
		pageViewaList.ll_photo.setOnClickListener(this);
...
//	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_send:
			sendMessage();
			break;
		case R.id.rl_sendphoto:
			hideKeyboard();
			if(pd%2==1){
				pageViewaList.sendphoto_unfold.setVisibility(View.GONE);
				pageViewaList.sendphoto_close.setVisibility(View.VISIBLE);
				
				pageViewaList.ll_selectpic.setVisibility(View.VISIBLE);
				pd++;
			}else{
				pageViewaList.sendphoto_unfold.setVisibility(View.VISIBLE);
				pageViewaList.sendphoto_close.setVisibility(View.GONE);
				
				pageViewaList.ll_selectpic.setVisibility(View.GONE);
				pd++;
			}
